...
for( ; ;) {
	...
	if(LAST == 2 && countby == 1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 2;
								factorial *= count++);
	...
	if(LAST == 3 && countby ==1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 3;
								factorial *= count++);
	...
	if(LAST == 4 && countby == 1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 4;
								factorial *= count++);
	...
	if(LAST == 5 && countby == 1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 5;
								factorial *= count++);
	...
	if(LAST == 6 && countby ==1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 6;
					factorial *= count++);
	...
	if(LAST == 7 && countby ==1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 7;
					factorial *= count++);
	...
	if(LAST == 8 && countby ==1 ){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 8;
					factorial *= count++);
	...
	if(LAST == 9 && countby == 1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 9;
					factorial *= count++);
	...
	if(LAST == 10 && countby == 1){
		for (count=0; count<LAST ;)
			...
			for ( factorial = 1, count = 1; count <= 10;
					factorial *= count++);
